...
<body>
	...
	<div>
		...
		<div class="tab">
			...
			<button class="active" onclick="form.action='DisplayModel';" name="procedureModelID" value="${model.id}">Procedure</button>
		...
		<div style="float:right; width:69%">	
			<div style="border: 2px solid gray">
				<h3>Procedure:</h3>
					<div style="padding-left:20px; padding-right:20px;">${model.procedure}</div><br>
			</div>
			<br>
		</div>
