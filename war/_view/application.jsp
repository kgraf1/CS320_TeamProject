			...
			<div style="border: 2px solid gray">
				<h3>Application:</h3>
					...
					<h4 style="padding-left:20px; padding-right:20px;">Before Image:</h4>	
						<div style="padding-left:40px; padding-right:20px;">${application.beforeImage}</div><br>
					...
					<h4 style="padding-left:20px; padding-right:20px;">During Image:</h4>	
						<div style="padding-left:40px; padding-right:20px;">${application.duringImage}</div><br>
			</div>
		</div>
		<br>
